          ...
          <div className="md:col-span-12 lg:col-span-5 flex flex-col gap-4 mt-4 lg:mt-0">
           ...
           <section className={clsx(
             ...
             isAllCompleted ? "[--clay-card-bg:var(--color-tertiary-container)]" : "[--clay-card-bg:var(--color-surface-container-low)]"
              ...
              <Link href={`/planner/new?date=${selectedDate.toISOString()}`} className="clay-button bg-primary text-white text-xs sm:text-sm font-bold px-4 sm:px-6 py-2.5 sm:py-3 inline-flex items-center gap-2 w-full justify-center">
